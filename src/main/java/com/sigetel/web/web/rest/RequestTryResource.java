...
public class RequestTryResource {
    ...
    @Timed
    public ResponseEntity<RequestTry> createRequestTry(@Valid @RequestBody RequestTry requestTry) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<RequestTry> updateRequestTry(@Valid @RequestBody RequestTry requestTry) throws URISyntaxException {
