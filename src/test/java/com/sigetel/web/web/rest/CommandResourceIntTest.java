...
import com.sigetel.web.repository.CommandRepository;
import com.sigetel.web.service.CommandService;
...
public class CommandResourceIntTest {
    ...
    public void setup() {
        ...
        CommandResource commandResource = new CommandResource(commandService);
